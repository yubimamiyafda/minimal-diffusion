...
Original file is located at
    https://colab.research.google.com/drive/1yqeJBR5GWfqjmj3kgXhBEgyPLYeT1IRB
"""
...
def sample_N_images(
    ...
    num_channels=3,
    image_size=128,
    #  want to sample larger images, changed from 32 to 128
    num_classes=None,
    args=None,
):
    ...
    while num_samples < N:
        ...
        samples.append(samples_list.detach().cpu().numpy())
        num_samples += len(xT)
...
def main():
    ...
    for epoch in range(args.epochs):
        # no sampler because not using torch distributed
